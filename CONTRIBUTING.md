...
in this project, you agree to abide by our [code of conduct](https://baldbeardedbuilder.com/code-of-conduct).
...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/baldbeardedbuilder.com.git

**All changes should be based from the `vNext` branch.**

Push to your fork and [submit a pull request](https://github.com/builders-club/baldbeardedbuilder.com/compare/) against the `vNext` branch.
